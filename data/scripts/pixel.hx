...
function onNoteCreation(event) {
	...
	if (event.note.isSustainNote) {
		note.loadGraphic(Paths.image('notes/endshit'), true, 7, 6);
		...
		note.loadGraphic(Paths.image('notes/pixelshit'), true, 17, 17);
...
function onStrumCreation(event) {
	...
	strum.loadGraphic(Paths.image('notes/pixelshit'), true, 17, 17);
