...
fatger = new FlxSprite(76.7474133080717, 35.0627744824032);
fatger.loadGraphic(Paths.image("ataria/fathers"));
fatger.frames = Paths.getSparrowAtlas("ataria/fathers");
fatger.animation.addByPrefix('danceleft', 'danceleft', 10, true);
fatger.animation.play('danceleft');
fatger.antialiasing = false;
fatger.cameras = [camHUD];
insert(fatger)
